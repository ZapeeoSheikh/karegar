...
class AddSkills extends StatefulWidget {
  const AddSkills({Key? key, required this.name, required this.email, required this.password, required this.phone, required this.cnic,  }) : super(key: key);
  final String name;
  final String email;
...
class _AddSkillsState extends State<AddSkills> {
                          ...
                          Expanded(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(color: MyColor.mainColor1, width: 3),
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Center(child: Text(
                                "Add Skills", style: TextStyle(color: MyColor.mainColor1, fontSize: 16.sp, fontWeight: FontWeight.bold),)),
                            ),
                          ),
                        ],
                      ),
                                              ...
                                              Container(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    i],
                                                    style: TextStyle(
                                                        color: i % 2 == 0 ? Colors.white : MyColor.mainColor1 ,
                                                        fontSize:
                                                        12),
                                                  ),
                                                ),
  ...
  Future<void> _openFilterDialog() async {
    await FilterListDialog.display<String>(
      ...
      validateSelectedItem: (list, val) => compare(list!,val),//contains(val.productTypeName),
