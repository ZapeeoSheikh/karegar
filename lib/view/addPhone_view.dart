...
import 'addCnic_view.dart';
import 'chooseRole_view.dart';
import 'login_view.dart';

class AddPhone extends StatefulWidget {
  const AddPhone({Key? key, required this.name, required this.email, required this.password,  }) : super(key: key);
  final String name;
  final String email;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Image(image: AssetImage("assets/Vector/phone.png")),
                    SizedBox(height: 80.h,),
                    TextField(
                      ...
                      onTap: (){
                        setState(() {
                          if (_controller
                            ...
                            if (_errorText1 ==
                                null) {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => AddCnic(name: widget.name, email: widget.email, password: widget.password, phone: _controller.text,)));
                            } else {
                              error1 = true;
